...
function About() {
  return (
    <div id="About" className="about-main-container pt-3">
      <div className="about-header display-4 text-center">About Me</div>
      <div className="about-inner-container container row m-auto gap-5 p-2 justify-content-around">
        <div className="about-box col-md-5 col-12 d-flex flex-column gap-3 py-4">
        ...
        <div className="about-box col-md-5 col-12 d-flex flex-column gap-3 py-4">
          <div className="fs-4">Language Skills</div>
          <ul>
            <li>Azerbaijan</li>
            <li>Turkish</li>
            <li>English </li>
        ...
        <div className="about-box col-md-5 col-12 py-2">
          <div className="fs-4">Educational History</div>
          <div className="d-flex flex-column">
            <p className="p-0 m-0 fw-bold">September 2019 - June 2023</p>
            <p className="p-0 m-0">
              Azerbaijan Technical University - Bachelor in Information
              Technologies
            </p>
          </div>
          <div className="d-flex flex-column">
